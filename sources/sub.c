...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/03 10:16:17 by enanrock          #+#    #+#             */
/*   Updated: 2018/04/03 10:20:54 by enanrock         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "sub.h"

static void		r1_minus_r2_in_r3(t_local_memory *read_head,
...
int				sub(void *p1, void *p2)
{
	...
	{
		r1_minus_r2_in_r3(read_head, mem->memory_space[(pc + 2) % MEM_SIZE],
